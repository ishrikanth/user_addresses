...
Stores the users and their addresses
Provides a REST API to manage them (No HTML viwes, only JSON output)
The User Entity
The user has the following properties

First Name (mandatory to have)
Middle Name (optional)
Last Name (optional)
Age
The user can have multiple addresss, with each address has the properties
...
GET /users/adults – List all users above 18 years
Retrieve a single user
GET /users/:id – Get the details of a user
Create User
POST /users Sample request body is given below:
 {
    "first_name":"John Doe",
    "middle_name": "Michael",
    "last_name": "Doe",
